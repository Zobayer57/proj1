		...
		?>
			...
			<section class="main">
				<form action="register.php" method ="POST" class="form-4" >
				 <h1>Register</h1>
	First name
<input class="form-control" name="Fname" placeholder="eg:Abdullah" type="text">
	Last name
<input class="form-control" name="Lname" placeholder="eg:Zobayer" type="text">
 Email
<input class="form-control" name="Email" placeholder="eg:zobayer10@yahoo.com" type="text">
