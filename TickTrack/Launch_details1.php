...
$query = "SELECT * FROM launch where Origin='{$origin}' and Destination='{$destination}' and Date='{$dateoj}'" ;
...
//	header('Refresh:5; url=generic.php');
	...
	echo '<h3 style= "text-align:center;"> <font color="red">No available launch </font></h3>';
	echo "<br>";
...
else
{
	...
	echo '<h3 style= "text-align:center;"> <font color="red"><center>Available launch</center></font></h3>';
echo '<table align="center" border=1 >
<tr>
<th> Id </th>
<th> Name of the launch </th>
...
while($row = mysqli_fetch_array($select_vehicle_query)){
	...
	echo "<td>";
//	echo "$req";
	echo '<a href="launch_payment1.php?Seats_no='.$req.'& Launch_id='.$Launch_id.'& Total_fare='.$Total_fare.'& Date='.$dateoj.'">Book Now</a>';
	echo "</td>";
	echo "</tr>";
}
echo "</table>";
