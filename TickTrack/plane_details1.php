...
$seats=$_POST["Seats"];
$Plane_id;
$query = "SELECT * FROM plane where Origin='{$origin}' and Destination='{$destination}' and Seats>= '{$seats}' and Date='{$dateoj}'" ;
...
//	header('Refresh:5; url=generic.php');
	...
	echo '<h3 style= "text-align:center;"> <font color="red">No available Planes </font></h3>';
	echo "<br>";
...
else
{
	...
	echo '<h3 style= "text-align:center;"> <font color="red"><center>Available Planes </center></font></h3>';
...
while($row = mysqli_fetch_array($select_vehicle_query)){
	...
	echo "<td>";
//	echo "$req";
	echo '<a href="plane_payment1.php?Seats_no='.$req.'& Plane_id='.$Plane_id.'& Total_fare='.$Total_fare.'& Date='.$dateoj.'">Book Now</a>';
	echo "</td>";
	echo "</tr>";
}
echo "</table>";
					...
					<section class="4u$ 12u$(medium) 12u$(small)">
						...
						<ul class="tabular">
								<li>
      							...
      							<li>
									<h3>Mail</h3>
									<a href="#">salmanipa2020@gmail.com</a>
								</li>
							</ul>
						</section>
