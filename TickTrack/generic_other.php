			...
			<section id="main" class="wrapper">
				<div class="container">
					...
					<header class="major">
						...
						<li><a href="generic_plane.php">Search for Planes tickets</a></li>
						<li><a href="generic_train.php">Search for Trains tickets</a></li>
						<li><a href="generic_launch.php">Search for Launch tickets</a></li>
					</header>
				</div>
			</section>
			
<a href="#" class="image fit"><img src="images1/train.jpg" alt="" /></a>
<a href="#" class="image fit"><img src="images1/plane.jpg" alt="" /></a>
</div>
