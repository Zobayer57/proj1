...
session_start();
$query="INSERT INTO train_booking (user,Train_id,Seats_no,Total_fare,Bank,Payment_method,Dep_date) VALUES('".$_SESSION['Username']."','".$_SESSION['Train_id']."','".$_SESSION['Seats_no']."','".$_SESSION['Total_fare']."','".$_POST['Bank']."','".$_POST['Payment_method']."','".$_SESSION['Dep_date']."')";
